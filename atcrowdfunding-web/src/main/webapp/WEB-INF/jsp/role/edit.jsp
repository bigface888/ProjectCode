    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:32px;" href="user.html">智能身份授权系统 - 角色维护</a></div>
        </div>
			  ...
			  <div class="panel-body">
				<form role="form" id="roleForm">
				  ...
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="name" placeholder="请输入新增角色名称" value="${role.name }">
				  </div>
        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#updateBtn").click(function(){
			    	...
			    	if ( rolename== "" ) {
                        layer.msg("角色名称名不能为空，请输入", {time:2000, icon:5, shift:6}, function(){
