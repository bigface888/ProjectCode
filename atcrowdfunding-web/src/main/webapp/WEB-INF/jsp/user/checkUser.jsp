...
<html lang="zh-CN">
  <head>
    ...
    <meta http-equiv="refresh" content="1000;url=/main.jsp">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
          <div><a class="navbar-brand" style="font-size:32px;" href="#">智能身份授权系统- 用户审核</a></div>
        </div>
	...
	<script src="${APP_PATH}/layer/layer.js"></script>
        <script type="text/javascript">
            ...
            function pageQuery( pageno ) {
            	...
            	$.ajax({
            		type : "POST",
            		url  : "${APP_PATH}/user/ajaxCheckUser",
            		data : jsonData,
            		beforeSend : function(){
            			...
            			if ( result.success ) {
            				...
            				$.each(users, function(i, user){
            	                tableContent += '<tr>';
	          	                ...
	          	                tableContent += '  <td>'+user.telephone+'</td>';
	          	                tableContent += '  <td>'+user.level+'</td>';
	          	                tableContent += '  <td>';
	          					tableContent += '      <button type="button" onclick="goUpdatePage('+user.id+')" class="btn btn-primary btn-xs"><i class=" glyphicon glyphicon-ok"></i></button>';
	          					tableContent += '      <button type="button" onclick="goUpdatePage('+user.id+')" class="btn btn-primary btn-xs"><i class=" glyphicon glyphicon-remove"></i></button>';
	          					tableContent += '  </td>';
	          	                tableContent += '</tr>';
            				});
